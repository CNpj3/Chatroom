 ...
 City* newNode(int label, City *E, City *N) {
  ...
  int main() {
          City *capital = newNode(0, NULL, NULL);
              capital->east = newNode(3, newNode(6, NULL, NULL), NULL);
                  capital->north = newNode(1, NULL, newNode(2, NULL, NULL));
                      capital->east->north = capital->north->east = newNode(4, NULL, NULL);
                       
                           City *temp = capital->east->north;
                               temp->east = newNode(7, NULL, NULL);
                                   temp->north = newNode(5, NULL, NULL);
